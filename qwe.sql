...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Янв 18 2022 г., 20:27
...
CREATE TABLE `результаты` (
  `id` int(11) NOT NULL,
  `имя спортсмена` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `соревнование` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `призер` varchar(3) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
